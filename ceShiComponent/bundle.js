...
function trigger(target, type, key, newValue, oldValue, oldTarget) {
  ...
  const eventInfo =
    process.env.NODE_ENV !== 'production' ? { target, type, key, newValue, oldValue, oldTarget } : undefined;
  if (deps.length === 1) {
    if (deps[0]) {
...
function clear() {
  ...
  const oldTarget =
    process.env.NODE_ENV !== 'production' ? (isMap(target) ? new Map(target) : new Set(target)) : undefined;
  // forward the operation before queueing reactions
...
function cloneVNode(vnode, extraProps, mergeRef = false) {
  ...
  const cloned = {
    ...
    children:
      process.env.NODE_ENV !== 'production' && patchFlag === -1 /* HOISTED */ && isArray(children)
...
var textComponentProps = __assign(
  __assign(
    {
      text: '正文内容',
      fontSize: '14px',
...
var imageComponentProps = __assign(__assign({ textAlign: 'left' }, commonDefaultProps), { src: '' });
var isEditingProp = {
  isEditing: {
    type: Boolean,
    default: false
...
var textStylePropNames = lodash.exports.without(Object.keys(textComponentProps), 'action', 'url', 'text');
lodash.exports.without(Object.keys(imageComponentProps), 'src');
var transformToComponentProps = function (props) {
  var mapProps = lodash.exports.mapValues(props, function (item) {
    return { type: item.constructor, default: item };
  });
  return __assign(__assign({}, mapProps), isEditingProp);
};

var useComponentCommon = function (props, picks) {
  var styleProps = computed(function () {
    return lodash.exports.pick(props, picks);
  });
...
var defaultProps = transformToComponentProps(textComponentProps);
var LText = defineComponent({
  name: 'mook-text',
  props: __assign(
    {
      tag: {
  ...
  setup: function (props) {
    ...
    var _a = useComponentCommon(props, textStylePropNames),
      styleProps = _a.styleProps,
      ...
      return (
        <div>
          {h(
            ...
            {
              style: __assign({}, styleProps.value),
              onClick: handleClick,
        ...
        <div class="color-picker">
          <div class="native-color-container">
            <input
              ...
              onInput={function (e) {
                var _a;
                onChange((_a = e.target) === null || _a === void 0 ? void 0 : _a.value);
              }}
            ></input>
          </div>
          <ul class="picked-color-list">
            {props.colors.map(function (item, index) {
              return (
                <li
                  key={index}
                  class={'item-'.concat(index)}
                  onClick={function () {
...
// import App from "./App";
var components = [LText, ColorPicker];
var instance = function (app) {
  components.forEach(function (component) {
    app.component(component.name, component);
  });
};
var main = { instance: instance };
// createApp(App).mount("#app");

export { ColorPicker, LText, main as default, instance };
